...
**
*Lesson: Is our model dynamically complete? Test, test, test.
use fertil3.dta
...
*We have evidence of at least an serial correlation to the order of one.
...
*1) Just a 1-year lag of unemployment
*2) 1-year lag of unemployment and 1-year lag of inflation
*Compare models
*OLS AR(1)
...
**One-step ahead we can use predict or forecast for AR(1) with lagged inflation
*Get 1997 estimates
